...
create sequence status_bookings_id_seq;
...
(
    ...
    CONSTRAINT fk_items_users_req FOREIGN KEY (request_id) REFERENCES users (id)
);
...
CREATE INDEX fk_requests_users_index ON requests (requestor_id);